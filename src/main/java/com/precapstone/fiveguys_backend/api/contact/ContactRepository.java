...
public interface ContactRepository extends JpaRepository<Contact, Long> {
    ...
    Optional<Contact> findByContactIdAndName(Long contactId, String name);
    Optional<Contact> findByGroupsAndName(Groups groups, String name);

    /** 특정 그룹에서 연락처 정보로 조회하는 함수 */
    Optional<Contact> findByContactIdAndTelNum(Long contactId, String name);
    ...
    /** 특정 주소록 하나를 삭제하는 함수 */
    Optional<Contact> deleteByContactId(Long contactId);
}
